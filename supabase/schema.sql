...
-- Helper function supaya policy tidak recursive.
...
drop policy if exists "Profiles can read own or teacher can read" on public.profiles;
...
drop policy if exists "Public can read students gallery" on public.students;
create policy "Public can read students gallery"
on public.students
for select
to public
using (true);
...
drop policy if exists "Anyone can read activity photos" on storage.objects;
create policy "Anyone can read activity photos"
on storage.objects
for select
to public
using (
...
drop policy if exists "Activities can be read by authenticated users" on public.activities;
drop policy if exists "Activities can be read by public" on public.activities;
create policy "Activities can be read by public"
...
drop policy if exists "Students and teachers can insert activities" on public.activities;
create policy "Students and teachers can insert activities"
on public.activities
for insert
to authenticated
with check (
  public.current_profile_role() in ('student', 'teacher')
);

drop policy if exists "Students and teachers can update activities" on public.activities;
create policy "Students and teachers can update activities"
on public.activities
for update
to authenticated
using (
